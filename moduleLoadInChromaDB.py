...
PATH_ChromaDB = "VectorDBStoreFolder"
...
def consumer(use_cuda, queue, nameCollection, dataBaseName):
    ...
    collection = chroma_client.get_collection(name=nameCollection, embedding_function=sentence_transformer_ef)
